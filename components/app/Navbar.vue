...
const routesRef = computed(() => {
  ...
  return config.navbar?.links.map((e) => {
    e["active"] =
      route.path.split("/")[0].includes(e.to) || route.path === e.to;
    return e;
  });
});
</script>
        ...
        >
          ...
          >
            ...
            <NuxtLink
              ...
              class="hidden md:block text-white bg-primary-900 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 text-center transition-all dark:bg-primary-900 dark:hover:bg-primary-800 dark:focus:ring-primary-800"
            >
